...
export function setTheme(themeName) {
    ...
    if (darkBtn && lightBtn) {
        if (themeName === 'dark') {
            darkBtn.style.background = 'var(--nd-accent)';
            darkBtn.style.color = 'var(--nd-on-accent)';
            lightBtn.style.background = 'var(--bg-hover)';
            lightBtn.style.color = 'var(--text-primary)';
        } else {
            lightBtn.style.background = 'var(--nd-accent)';
            lightBtn.style.color = 'var(--nd-on-accent)';
